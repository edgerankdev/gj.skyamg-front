    ...
    sec2: [
      {
        title1: "수술 치료의 정점",
        title2: "SKY 정형신경센터",
        description: `정형신경센터는 뇌 질환, 척수 질환 등 신경계 질환에 대한 외과적 치료를 병행하는 진료과 입니다. 강아지에서 호발하는 후두골이형성(COMS, Caudal occipital malformation syndrome), 뇌수두증, 종양 및 디스크 질환(IVDD, Intervertebral disc disease)에 대한 보존적 치료 및 수술적 치료를 실시하고 있으며, 전문가의 정확한 신경계 검사, 질환 부위의 국소화 및 첨단 영상의학 장비를 통한 수술 부위에 대한 확정 진단을 통해 술 후 회복기간을 단축 시키고, 최상의 술 후 경과를 낼 수 있도록 영상의학과와 협진이 이루어지고 있습니다.
      `,
      },
    ],
    sec3: [
    ...
    equip: [
      {
        ...
        name: "FUME HOOD",
        description:
          "주사제를 뽑을 때 압력 차로 인한 약물의 누출과 주삿바늘에 남을 수 있는 잔량의 약물이 공기 중으로 누출되는 것을 막기 위해 고안된 특수장치로, 사용자 및 환경을 안전하게 보호하기 위해 국제 규격에 따른 설계, 제작, 자체 검증이 완료된 안전장치입니다.",
      },
    ],
    // surgery: [],
    pride: {
